...
%As a result, we see that $\strongbp \cdot C \subseteq \strongbp \cdot Q_k \cdots Q_1 \cdot \p$, where at least one of the $Q_i$ is $\parity$. and all of the $Q_i$ are either $\strongbp, \bp$, or $\parity$.
