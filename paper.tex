...
\begin{itemize}
\item $f(x) = 1$ if and only if there exists a $y \in \{0,1\}^{p(|x|)}$ such that $g(\langle x,y \rangle) = 1$.
\item $f(x) = 0$ if and only if for every $y \in \{0,1\}^{p(|x|)}$, we have $g(\langle x, y\rangle) = 0$.
\item $f(x) = \x$ otherwise.
\end{itemize}
\end{definition}
...
\begin{itemize}
\item $f(x) = 1$ if and only if for every $y \in \{0,1\}^{p(|x|)}$, we have $g(\langle x,y \rangle) = 1$.
\item $f(x) = 0$ if and only if there exists $y \in \{0,1\}^{p(|x|)}$ such that $g(\langle x, y\rangle) = 0$.
\item $f(x) = \x$ otherwise.
\end{itemize}
\end{definition}
